...
export const checkEligibility = async (req, res) => {
    try {
        const scholarshipId = req.params.id;
        const { studentType, academicScore, familyIncome, age, nationality } = req.body;
        ...
        const isEligible = scholarship.eligibility.studentType.some(type => studentType.includes(type)) &&
