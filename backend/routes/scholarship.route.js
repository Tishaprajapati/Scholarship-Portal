...
import { checkEligibility, createScholarship, getAllScholarships, getScholarshipById } from "../controllers/scholarship.controllers.js";
...
router.get("/getAllScholarship", getAllScholarships); // Get all scholarships
